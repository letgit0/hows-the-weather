      ...
      >
        ...
        >
          <div className="rounded-2xl bg-white/60 p-3 sm:p-4 text-center shadow-sm">
            <p className="text-[11px] sm:text-xs uppercase tracking-widest text-gray-500">
              Humidity
            </p>
          ...
          <div className="rounded-2xl bg-white/60 p-3 sm:p-4 text-center shadow-sm">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-gray-800 mt-2">
              12
              <span className="text-sm sm:text-base ml-1 font-medium">
                km/h
              </span>
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-white/60 p-3 sm:p-4 text-center shadow-sm">
            <p className="text-[11px] sm:text-xs uppercase tracking-widest text-gray-500 whitespace-nowrap">
              Feels Like
            </p>
